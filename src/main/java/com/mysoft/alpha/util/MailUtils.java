...
public class MailUtils {
    ...
    public void send(String host, String user, String pwd) {
        ...
        try {
            ...
            // 添加附件的标题
            // 如有乱码，通过下面的Base64编码的转换可以保证你的中文附件标题名在发送时不会变成乱码
...
//                    + enc.encode(affixName.getBytes()) + "?=");
    ...
    public static void main(String[] args) {
        ...
        // 设置发件人地址、收件人地址和邮件标题
        cn.setAddress("onetreehill2020@163.com", "onetreehill2020@163.com", "一个带附件的JavaMail邮件");
        // 设置要发送附件的位置和标题
        cn.setAffix("e:/豆瓣T250书单.txt", "豆瓣T250书单.txt");
         ...
         */
        cn.send("smtp.163.com", "onetreehill2020@163.com", "YJGCKUAWCGGBBUWF");
